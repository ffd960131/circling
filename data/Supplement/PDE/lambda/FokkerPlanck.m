clear; clc;
AA={'λ=0.72','λ=0.76','λ=0.80','λ=0.84','λ=0.88','λ=0.92'};
figSize = 1000; % 正方形边长，单位像素
f = figure('Color','w');
f.WindowState = 'maximized';

%% 保证宽高比例（手动设置 figure 尺寸）
...
% exportgraphics(gcf, 'simulate_kern_7.svg','ContentType','vector','BackgroundColor','none');
