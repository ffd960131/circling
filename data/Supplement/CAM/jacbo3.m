...
xlim([0 1]); ylim([-1 3]); yticks(-1:1:3);

exportgraphics(f1,'j3_1.svg','ContentType','vector','BackgroundColor','none');
...
[th_grid, ph_grid] = meshgrid(linspace(0,4,20), linspace(0,4,20));
lam = lam_lo;
...
exportgraphics(f2,'j3_2.svg','ContentType','vector','BackgroundColor','none');
